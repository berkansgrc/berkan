        ...
        <div className="relative z-10 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-sm font-black uppercase tracking-widest text-foreground">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li><Link className="hover:text-primary transition-colors" href="#">Gizlilik</Link></li>
                <li><Link className="hover:text-primary transition-colors" href="#">Şartlar</Link></li>
              </ul>
            </div>
            <div className="space-y-4">
              <p className="text-foreground/50">Destek</p>
              <ul className="space-y-3">
                <li><Link className="hover:text-primary transition-colors" href="#">SSS</Link></li>
                <li><Link className="hover:text-primary transition-colors" href="#">İletişim</Link></li>
              </ul>
            </div>
          </div>
        </div>
